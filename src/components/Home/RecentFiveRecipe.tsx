  ...
  return (
    <div className=" mx-3 md:mx-8 lg:mx-20 my-10">
      <div className="flex justify-center">
        <h1 className=" text-4xl bg-black rounded-lg px-4 py-2 text-white font-bold">
          Recent Recipe
        </h1>
      </div>
            ...
            <Link href={`/recipeDetails/${recipe._id}`}>
              <div className="bg-white relative p-3 shadow-xl rounded-lg">
                <Image
                  ...
                  className="w-full object-cover h-[300px] rounded-md pb-10"
                  height={300}
                  src={recipe.image}
                  width={300}
                />
                <div className="absolute inset-0 flex items-center justify-center top-52">
                  <div>
                    <div className="flex justify-center">
                      <h1 className="bg-[#1BEEA2] inline-block px-1 text-xs ">
          ...
          >
            <Link href={`/recipeDetails/${recipe._id}`}>
              <div className="bg-white relative p-3 shadow-xl rounded-lg">
                <Image
                  alt={`${recipe.title} recipe image.`}
                  className="w-full object-cover  rounded-md pb-10"
                  height={300}
                  src={recipe.image}
                  width={400}
                />
