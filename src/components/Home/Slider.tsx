          ...
          <SwiperSlide key={index}>
            <div className="relative group rounded-lg w-full overflow-hidden">
              ...
              <div className="absolute bg-black/40 inset-0 flex items-center justify-center text-white ">
                <div>
                  <p className="bg-[#1BEEA2] px-2 py-[2px] text-black rounded-sm text-xs">
                    {slide.category}
                  </p>
                  <p className="mt-2 relative inline-block cursor-pointer after:content-[''] after:absolute after:left-0 after:bottom-0 after:w-0 after:h-[2px] after:bg-white hover:after:w-full after:transition-all after:duration-500">
                    {slide.foodName}
                  </p>
