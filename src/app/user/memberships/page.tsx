...
const Membership = () => {
    ...
    return (
        <div>
            <h1 className='text-3xl font-bold text-center my-10'>Upgrade your plan</h1>
            <div className='flex justify-center gap-x-7'>
                <div className="border border-gray-300 rounded-lg shadow-lg w-[300px] p-6 bg-white hover:shadow-2xl transition duration-300">
                    <h1 className="text-4xl font-bold text-center text-gray-800 mb-4">Basic</h1>
                    ...
                    <Button onClick={() => handleCheckout(0)} className="mt-6 bg-blue-500 text-white font-semibold py-2 px-6 rounded-md hover:bg-blue-600 transition duration-300 mx-auto block">
                        Get Started
                    </Button>
                </div>
                <div className="border border-[#1beea2] rounded-lg shadow-lg w-[300px] p-6 bg-white hover:shadow-2xl transition duration-300">
                    <h1 className="text-4xl font-bold text-center text-gray-800 mb-4">Premium</h1>
                    ...
                    <Button onClick={() => handleCheckout(19.99)} className="mt-6 bg-[#1beea2]  font-semibold py-2 px-6 rounded-md hover:bg-[#3ad29a] transition duration-300 mx-auto block">
                        Go Premium
                    </Button>
                </div>
            </div>
